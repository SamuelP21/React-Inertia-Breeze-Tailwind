import{r as f,j as o}from"./app-QmDeuFiI.js";function M({htmlContent:c}){const[d,u]=f.useState(!1),i=f.useMemo(()=>{if(!c)return{success:!1,error:"No hay contenido HTML para procesar",content:null};try{console.log("🚀 Template Renderer - Renderizado directo optimizado...");let n=c;n.includes("\\")&&(n=n.replace(/\\n/g,`
